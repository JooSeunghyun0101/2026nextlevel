...
const Hero: React.FC<HeroProps> = ({
  ...
  const defaultGradient1 = "bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300";
  const defaultGradient2 = "bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400";
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        <div className="text-center space-y-6 max-w-7xl mx-auto px-4">
          ...
          <div className="space-y-2">
            <h1 className={`text-6xl md:text-8xl lg:text-9xl font-bold ${gradientClasses || defaultGradient1} bg-clip-text text-transparent animate-fade-in-up animation-delay-200 whitespace-nowrap`}>
              {headline.line1}
            </h1>
            <h1 className={`text-6xl md:text-8xl lg:text-9xl font-bold ${gradientClasses || defaultGradient2} bg-clip-text text-transparent animate-fade-in-up animation-delay-400 whitespace-nowrap`}>
              {headline.line2}
            </h1>
          </div>
          ...
          <div className="max-w-3xl mx-auto animate-fade-in-up animation-delay-600">
            <p className="text-3xl md:text-4xl lg:text-5xl text-orange-200 font-medium leading-relaxed">
              {subtitle}
            </p>
          </div>
